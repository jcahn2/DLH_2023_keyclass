...
notes = as_tibble(fread('C:/Users/jeremy/OneDrive - University of Illinois - Urbana/CS598DLH/project/FasTag/FasTag/data/NOTEEVENTS.csv'))# actual file use when testing is done
...
diagnoses = as_tibble(fread('C:/Users/jeremy/OneDrive - University of Illinois - Urbana/CS598DLH/project/FasTag/FasTag/data/DIAGNOSES_ICD.csv'))
...
# Write to file
##################################################################################
write.csv(icd9NotesDataTable, 'C:/Users/jeremy/OneDrive - University of Illinois - Urbana/CS598DLH/project/FasTag/FasTag/data/icd9NotesDataTable.csv')
write.csv(icd9NotesDataTable_train, 'C:/Users/jeremy/OneDrive - University of Illinois - Urbana/CS598DLH/project/FasTag/FasTag/data/icd9NotesDataTable_train.csv')
write.csv(icd9NotesDataTable_valid, 'C:/Users/jeremy/OneDrive - University of Illinois - Urbana/CS598DLH/project/FasTag/FasTag/data/icd9NotesDataTable_valid.csv')
